...
Plots are saved to plots/{model}/rbm_compare/.

Usage:
    python scripts/plot_rbm_comparison.py
    python scripts/plot_rbm_comparison.py --results path/to/results --method custom/metropolis
"""
...
def plot_rbm_comparison(results: dict, method_filter: str = None):
    ...
    for (model, N, h, method), rbm_data in sorted(results.items()):
        ...
        out_dir = PLOTS_DIR / model / "rbm_compare"
